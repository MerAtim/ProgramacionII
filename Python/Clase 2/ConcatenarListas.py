...
# Le pasamos por parámetro el elemento para averiguar el índice. Si el elemento no existe, nos da error.
...
print(lista3)
# El slicing lista[inicio:fin:paso] permite manipular la lista de forma versatil sin modificar e original.
print(lista3[::-1])
