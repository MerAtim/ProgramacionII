...
print(nombres[1])
print(nombres[3])
# Si no se sabe la longitud de la lista y se quiere conocer el último elemento, se indica el índice -1.
print(nombres[-1])
...
# Muestra los elementos de la lista desde el primer elemento hasta el indice indicado sin incluirlo.
print(nombres[:3])
# Muestra desde el índice indicado hasta el último elemento de la lista.
print(nombres[1:])
...
# A la funcion len debemos pasarle por parámetro la lista que queremos revisar.
print(len(nombres))
