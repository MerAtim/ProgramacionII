...
# Creamos la lista donde vamos a guardar los diccionarios de los personajes.
personajes = []

P1 = {"Nombre": "Aragorn", "Clase": "Guerrero",
      "Raza": "Dunadan del Norte"}  # creamos el primer diccionario
