...
# creamos un rango de 50 numeros consecutivos y lo convertimos a lista. Se guarda en la lista ListaNumeros.
listaNumeros = list(range(1, 51))

# Para mostrar el resultado en la forma especificada, creamos una variable resultado.
resultado = ''

for i in range(len(listaNumeros)):
    # Mientras el numero final no sea 50, se le va a añadir a cada numero un guion.
