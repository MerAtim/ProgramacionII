...
.proyecto-links a:hover .git-button {
    /* Aquí puedes agregar efectos al pasar el ratón */
    transform: scale(1.1); /* Ejemplo: aumentar un poco el tamaño */
}

.imagenes {
    display: flex;
    flex-direction: column; /* Cambia la dirección de las imágenes */
